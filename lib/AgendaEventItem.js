  ...
  ((_temp = _class = (function(_Component) {
    ...
    function AgendaEventItem(props) {
      ...
      return _possibleConstructorReturn(
        this,
        (
          AgendaEventItem.__proto__ || Object.getPrototypeOf(AgendaEventItem)
        ).call(this, props)
      );
    }
    ...
    _createClass(AgendaEventItem, [
      {
        ...
        value: function render() {
          ...
          var titleText = schedulerData.behaviors.getEventTextFunc(
            schedulerData,
            eventItem
          );
          var content = _react2.default.createElement(
            _EventItemPopover2.default,
            _extends({}, this.props, {
          ...
          return config.eventItemPopoverEnabled
            ...
            : _react2.default.createElement(
                ...
                _react2.default.createElement(
                  ...
                  {
                    className: "day-event",
                    // style: { maxWidth: config.agendaMaxEventWidth }
                    style: { maxWidth: cellWidth - 5 }
                  },
                  eventItemTemplate
                )
              );
