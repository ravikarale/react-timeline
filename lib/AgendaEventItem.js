...
var AgendaEventItem = (_temp = _class = function (_Component) {
    ...
    _createClass(AgendaEventItem, [{
        ...
        value: function render() {
            ...
            if (eventItemTemplateResolver != undefined) eventItemTemplate = eventItemTemplateResolver(eventItemClick, schedulerData, eventItem, bgColor, isStart, isEnd, 'event-item', config.eventItemHeight, config.agendaMaxEventWidth);
            ...
            return config.eventItemPopoverEnabled ? _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'a',
                    { className: 'day-event', style: {maxWidth: config.agendaMaxEventWidth} },
                    eventItemTemplate
                )
            );
        }
