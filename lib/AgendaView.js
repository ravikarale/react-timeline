...
var AgendaView = (_temp = _class = function (_Component) {
    ...
    _createClass(AgendaView, [{
        ...
        value: function render() {
            ...
            // var agendaResourceTableWidth = config.agendaResourceTableWidth,
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'table',
                        { style: { borderTop: 0 }, className: 'scheduler-table' },
                        _react2.default.createElement(
                            'thead',
                            null,
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'th',
                                    { style: { width: agendaResourceTableWidth - 1 }, className: 'header3-text' },
                                    resourceName
                                ),
                                _react2.default.createElement(
                                    'th',
                                    { className: 'header3-text border-top' },
                                    agendaViewHeader
                                )
                            )
                        ),
