...
var SchedulerData = function () {
    ...
    _createClass(SchedulerData, [{
        ...
        key: 'setEventItemLineHeight',
        value: function setEventItemLineHeight(newEventItemLineHeight) {
            this.config.eventItemLineHeight = newEventItemLineHeight;
        }
    },{
        key: 'setEventItemHeight',
        value: function setEventItemHeight(newEventItemHeight) {
            this.config.eventItemHeight = newEventItemHeight;
        }
    }, {
        ...
        value: function getContentTableWidth() {
            return (this.viewType == 0 ? 7 : this.headers.length) * this.getContentCellWidth();
        }
    }, {
                    ...
                    resourceEvents.headerItems.forEach(function (header, index) {
                        ...
                        if (headerEnd > eventStart && headerStart < eventEnd) {
                            ...
                            if (header.count > resourceEvents.rowMaxCount) {
                                ...
                                // var newHeightCount = resourceEvents.rowMaxCount * 50
                                var newHeightCount = resourceEvents.rowMaxCount * (_this5.config.eventItemHeight + 5)
                                if(newHeightCount > _this5.config.eventItemLineHeight){
                                    resourceEvents.rowHeight = newHeightCount;
                                }
                            }
