    ...
    _createClass(BodyView, [{
        ...
        value: function render() {
            ...
            var tableRows = displayRenderData.map(function (item) {
                ...
                return _react2.default.createElement(
                    'tr',
                    { key: item.slotId, style: bgColorExceptLoggedinUser && item.slotId != userId ? { height: item.rowHeight, backgroundColor: config.otherUserTimeBodyBgColor } : { height: item.rowHeight } },
                    rowCells
                );
            });
