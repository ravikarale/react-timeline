    ...
    _createClass(EventItem, [{
        ...
        value: function render() {
            ...
            var content = _react2.default.createElement(_EventItemPopover2.default, _extends({}, this.props, {
                ...
                statusColor: bgColor,
                projectName: eventItem.projectName }));
            ...
            if (eventItemTemplateResolver != undefined) eventItemTemplate = eventItemTemplateResolver(eventItemClick, schedulerData, eventItem, bgColor, isStart, isEnd, 'event-item', config.eventItemHeight, undefined);

            var a = _react2.default.createElement(
                'a',
                { className: 'timeline-event', style: { left: left, width: width, top: top } },
                eventItemTemplate,
                startResizeDiv,
                endResizeDiv
            );
