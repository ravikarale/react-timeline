...
var Scheduler =
  ((_temp = _class = (function(_Component) {
    ...
    function Scheduler(props) {
      ...
      var _this = _possibleConstructorReturn(
        this,
        (Scheduler.__proto__ || Object.getPrototypeOf(Scheduler)).call(
          this,
          props
        )
      );
      ...
      var sources = [];
      sources.push(
        new _DnDSource2.default(function(props) {
      ...
      if (dndSources != undefined && dndSources.length > 0) {
        sources = [].concat(
          ...
          _toConsumableArray(dndSources)
        );
      }
      var dndContext = new _DnDContext2.default(
        sources,
        _ResourceEvents2.default
      );
      ...
      },
      {
        ...
        value: function render() {
          ...
          var renderData = schedulerData.renderData,
            ...
            customViewType = config.calenderViewType;

          var width = schedulerData.getSchedulerWidth();
          var calendarPopoverEnabled = config.calendarPopoverEnabled;

          var customViewTypeButtons = _props.customeVeiwTypeButtons(
            config,
            this.onCustomViewChange
          );
          var customeDatePicker = _props.customeDatePicker();

          var dateLabel = schedulerData.getDateLabel();
          var defaultValue =
            "" + viewType + (showAgenda ? 1 : 0) + (isEventPerspective ? 1 : 0);
          ...
          var viewOptionList = config.views.map(function(item) {
            return _react2.default.createElement(
              "option",
              {
                key:
          ...
          if (showAgenda) {
            ...
            var resourceName = schedulerData.isEventPerspective
              ? config.taskName
              : config.resourceName;
            tbodyContent = _react2.default.createElement(
              "tr",
          ...
          if (config.headerEnabled) {
            schedulerHeader = _react2.default.createElement(
              ...
              _react2.default.createElement(
                _col2.default,
                {
                  style: { borderBottom: "solid 1px #d6d6d6", height: "35px" }
                },
                _react2.default.createElement(
                  "div",
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement("tbody", null, tbodyContent)
          );
        }
      }
    ]);
  ...
  (_initialiseProps = function _initialiseProps() {
    ...
    this.resolveScrollbarSize = function() {
      ...
      if (!!_this3.schedulerContent) {
        contentScrollbarHeight =
          _this3.schedulerContent.offsetHeight -
          _this3.schedulerContent.clientHeight;
        contentScrollbarWidth =
          _this3.schedulerContent.offsetWidth -
          _this3.schedulerContent.clientWidth;
      }
      if (!!_this3.schedulerResource) {
        resourceScrollbarHeight =
          _this3.schedulerResource.offsetHeight -
          _this3.schedulerResource.clientHeight;
        resourceScrollbarWidth =
          _this3.schedulerResource.offsetWidth -
          _this3.schedulerResource.clientWidth;
      }
      if (
        !!_this3.schedulerContentBgTable &&
        !!_this3.schedulerContentBgTable.offsetHeight
      ) {
    ...
    this.onSchedulerHeadScroll = function(proxy, event) {
      if (
        (_this3.currentArea === 2 || _this3.currentArea === -1) &&
        _this3.schedulerContent.scrollLeft != _this3.schedulerHead.scrollLeft
      )
        _this3.schedulerContent.scrollLeft = _this3.schedulerHead.scrollLeft;
    };
    ...
    this.onSchedulerResourceScroll = function(proxy, event) {
      if (
        (_this3.currentArea === 1 || _this3.currentArea === -1) &&
        _this3.schedulerContent.scrollTop != _this3.schedulerResource.scrollTop
      )
        _this3.schedulerContent.scrollTop = _this3.schedulerResource.scrollTop;
    };
    ...
    this.onSchedulerContentScroll = function(proxy, event) {
      if (_this3.currentArea === 0 || _this3.currentArea === -1) {
        if (
          _this3.schedulerHead.scrollLeft != _this3.schedulerContent.scrollLeft
        )
          _this3.schedulerHead.scrollLeft = _this3.schedulerContent.scrollLeft;
        if (
          _this3.schedulerResource.scrollTop !=
          _this3.schedulerContent.scrollTop
        )
          _this3.schedulerResource.scrollTop =
            _this3.schedulerContent.scrollTop;
      }
      ...
      if (_this3.schedulerContent.scrollLeft !== scrollLeft) {
        if (
          _this3.schedulerContent.scrollLeft === 0 &&
          onScrollLeft != undefined
        ) {
          onScrollLeft(
            schedulerData,
            _this3.schedulerContent,
            _this3.schedulerContent.scrollWidth -
              _this3.schedulerContent.clientWidth
          );
        }
        if (
          _this3.schedulerContent.scrollLeft ===
            _this3.schedulerContent.scrollWidth -
              _this3.schedulerContent.clientWidth &&
        ...
        if (
          _this3.schedulerContent.scrollTop === 0 &&
          onScrollTop != undefined
        ) {
          onScrollTop(
            schedulerData,
            _this3.schedulerContent,
            _this3.schedulerContent.scrollHeight -
              _this3.schedulerContent.clientHeight
          );
        }
        if (
    ...
    this.onCustomViewChange = function(value) {
      var _props3 = _this3.props,
        onViewChange = _props3.onViewChange,
        schedulerData = _props3.schedulerData;

      var viewType = parseInt(value.charAt(0));
      var showAgenda = value.charAt(1) === "1";
      var isEventPerspective = value.charAt(2) === "1";
      onViewChange(schedulerData, {
        viewType: viewType,
        showAgenda: showAgenda,
        isEventPerspective: isEventPerspective
